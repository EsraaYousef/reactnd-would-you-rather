let users = {
  sarahedo: {
    id: "sarahedo",
    name: "Sarah Edo",
    avatarURL: "http://localhost:3000/images/avatars/woman.png",
    answers: {
  ...
  tylermcginnis: {
    id: "tylermcginnis",
    name: "Tyler McGinnis",
    avatarURL: "http://localhost:3000/images/avatars/man.png",
    answers: {
  ...
  johndoe: {
    id: "johndoe",
    name: "John Doe",
    avatarURL: "http://localhost:3000/images/avatars/man-1.png",
    answers: {
